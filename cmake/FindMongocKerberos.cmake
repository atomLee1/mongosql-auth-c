IF(APPLE)
    ...
    set(MONGOC_KRB_LIBS "-framework GSS")
ELSEIF(WIN32)
    MESSAGE(STATUS "Using SSPI for mongoc kerberos")
    set(MONGOSQL_AUTH_ENABLE_SASL_SSPI 1)
    set(MONGOC_KRB_LIBS secur32.lib Shlwapi.lib)
ELSE()
    MESSAGE(STATUS "Using GSSAPI for mongoc kerberos")
    set(MONGOSQL_AUTH_ENABLE_SASL_GSSAPI 1)
    include(FindGSSAPI)
    if (GSS_FOUND)
        set(MONGOC_KRB_LIBS ${GSS_LIBS})
...
MESSAGE(STATUS "using kerberos library: ${MONGOC_KRB_LIBS}")
